...
# ---------------------------------------------------------------------------
# batch_shell_script_dual_wl_aug.sh
#
# Wrapper script to run dual-wavelength augmented simulation metric computation
...
# the batch worker script `dual_wl_metrics_batch_aug.py` with regularization
# and spatial basis function parameters.
#
# Usage (example):
#   qsub batch_shell_script_dual_wl_aug.sh 1.0 0.01 0 0
#   qsub batch_shell_script_dual_wl_aug.sh 10.0 0.001 1 5
#
# Arguments:
